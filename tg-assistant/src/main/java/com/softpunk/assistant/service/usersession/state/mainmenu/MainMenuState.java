package com.softpunk.assistant.service.usersession.state.mainmenu;

import com.softpunk.bot.keyboards.KbMainMenu;
import com.softpunk.bot.usersession.UserSession;
import com.softpunk.bot.usersession.state.State;
import com.softpunk.bot.usersession.state.mainmenu.callbacks.ToCreateNewScheduleCallback;
import com.softpunk.bot.usersession.state.mainmenu.callbacks.ToUserScheduleListCallback;
