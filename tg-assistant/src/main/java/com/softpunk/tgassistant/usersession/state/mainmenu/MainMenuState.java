package com.softpunk.tgassistant.usersession.state.mainmenu;

import com.softpunk.dao.ScheduleRepository;
import com.softpunk.localization.Aliases;
import com.softpunk.tgassistant.keyboard.KbMainMenu;
import com.softpunk.tgassistant.usersession.UserSession;
import com.softpunk.tgassistant.usersession.state.State;
import com.softpunk.tgassistant.usersession.state.mainmenu.callbacks.ToCreateNewScheduleCallback;
import com.softpunk.tgassistant.usersession.state.mainmenu.callbacks.ToUserScheduleListCallback;
