...
public class Beans {
    ...
    @Bean
    public Bot bot(BotCredentials botCredentials) throws TelegramApiException {
        return new Bot(new InitBotSettings(botCredentials.getToken(), botCredentials.getName(), null));
    }
}
